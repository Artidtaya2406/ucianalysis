...
st.page_link("pages/3🐷KNNClassification.py", label="การนำเสนอข้อมูลด้วย KNN", icon="1️⃣", disabled=False)
st.page_link("pages/4🐱DecisionTreeClassify.py", label="การนำเสนอข้อมูลด้วย DecisionTree", icon="1️⃣", disabled=False)
